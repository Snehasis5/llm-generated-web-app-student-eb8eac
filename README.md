...
## Usage
The app loads `main.js` to initialize functionality based on the brief and attachments.

## Code Explanation
- `index.html`: main page
- `main.js`: minimal logic for the task
- Assets: copied from attachments when provided
